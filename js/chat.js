...
const ChatEngine = {
    ...
    renderMessages: function() {
        ...
        this.messages.forEach(msg => {
            ...
            div.style.cssText = `margin-bottom: 12px; padding: 10px 14px; border-radius: 12px; max-width: 85%; ${isTeacher ? 'background: rgba(0, 242, 254, 0.12); border: 1px solid rgba(0, 242, 254, 0.3); margin-right: auto;' : 'background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.08); margin-left: auto;'}`;
